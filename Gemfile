...
gem 'spree_auctions', '2.0.62', github: 'enbake/spree_auctions_enbake',:branch => 'select_winner'
# gem 'spree_auctions', '2.0.62', path: '/home/enbake/workspace/spreeapp/spree_auctions_enbake'
