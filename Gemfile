...
gem 'spree_auctions', '2.0.77', github: 'enbake/spree_auctions_enbake',:branch => 'detail_page_theme'
#gem 'spree_auctions', '2.0.77', path: '/home/enbake/dev/spreeapp/spree_auctions_enbake'
