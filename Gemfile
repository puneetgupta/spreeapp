...
gem 'spree_auctions', '2.0.51', github: 'enbake/spree_auctions_enbake',:branch => 'select_winner'
#gem 'spree_auctions', '2.0.50', path: '/home/enbake/dev/spreeapp/spree_auctions_enbake'
