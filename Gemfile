...
gem 'spree_auctions', '2.0.64', github: 'enbake/spree_auctions_enbake',:branch => 'auth_page'
# gem 'spree_auctions', '2.0.64', path: '/home/enbake/spreeapp/spree_auctions_enbake'
