...
gem 'spree_auctions', '2.0.53', github: 'enbake/spree_auctions_enbake',:branch => 'select_winner'
#gem 'spree_auctions', '2.0.53', path: '/home/enbake/dev/spreeapp/spree_auctions_enbake'
