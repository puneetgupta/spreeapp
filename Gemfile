...
gem 'spree_auctions', '2.0.82', github: 'enbake/spree_auctions_enbake',:branch => 'detail_page_theme'
#gem 'spree_auctions', '2.0.82', path: '/home/enbake/dev/spreeapp/spree_auctions_enbake'
