...
gem 'spree_auctions', '2.0.70', github: 'enbake/spree_auctions_enbake',:branch => 'detail_page_theme'
# gem 'spree_auctions', '2.0.70', path: '/home/enbake-3/workspace/spreeapp/spree_auctions_enbake'
