...
gem 'spree_auctions', '2.0.72', github: 'enbake/spree_auctions_enbake',:branch => 'detail_page_theme'
# gem 'spree_auctions', '2.0.72', path: '/home/enbake-3/workspace/spreeapp/spree_auctions_enbake'
