...
gem 'spree_auctions', '2.0.65', github: 'enbake/spree_auctions_enbake',:branch => 'detail_page_theme'
# gem 'spree_auctions', '2.0.65', path: '/home/enbake/spreeapp/spree_auctions_enbake'
